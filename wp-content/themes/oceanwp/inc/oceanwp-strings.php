	...
	function oceanwp_theme_strings( $value, $echo = true ) {
		...
		$oceanwp_strings = apply_filters(
			...
			array(
				...
				'owp-string-search-continue-reading'     => apply_filters( 'ocean_search_continue_reading', __( 'Xem chi tiết', 'oceanwp' ) ),
				'owp-string-post-continue-reading'       => apply_filters( 'ocean_post_continue_reading', __( 'Xem chi tiết', 'oceanwp' ) ),
